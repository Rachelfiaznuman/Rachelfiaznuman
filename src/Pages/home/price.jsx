        ...
        <div class="container-fluid   py-5">
            <div className="container">
                ...
                <div className="row mt-5 d-flex justify-content-between">
                    ...
                    <div class="container text-center py-5 rounded border pri ">
                     ...
                     <button class="py-2 px-4 rounded button2">Purchase Now</button>
                 </div>
                    </div>
                    <div className="col-lg-4 col-md-6 col-sm-12 mb-3 ">
                    <div class="container text-center py-5 rounded  border pri ">
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 mb-3 ">
                    <div class="container text-center py-5 border rounded pri">
