          ...
          <div className="containerr-fluid  py-5 max">
                <div className="row d-flex justify-content-center align-items-center">
                    <div className="col-lg-6  col-md-12 col-sm-12 col-12 d-flex justify-content-center align-items-center ">
                        <div className="main">
                        {/* <ShakaPlayer autoPlay src="https://youtu.be/8mb-0qbq984" width="100%" height="100%"/> */}
                        <ReactPlayer className="react-player" url="https://youtu.be/8mb-0qbq984" width="100%" height="100%"></ReactPlayer>
                    </div>
                    </div>
