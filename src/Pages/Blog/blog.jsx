...
export default class BlogPage extends React.Component {
  ...
  <input type="text" class="form-control pb-5" id="exampleFormControlInput1" placeholder="Comments"/>
  <div class="mb-3 row d-flex justify-content-between">
      <div className="col-lg-4 col-md-4 col-sm-12 col-12">

      
  <input type="text" class="form-control mt-4 w-100 " id="exampleFormControlInput1" placeholder="Your Name"/>
  </div>
  <div className="col-lg-4 col-md-4 col-sm-12 col-12">
  <input type="email" class="form-control mt-4 w-100" id="exampleFormControlInput1" placeholder="Your Email"/>

  </div>
  <div className="col-lg-4 col-md-4 col-sm-12 col-12">
  <input type="text" class="form-control mt-4 w-100" id="exampleFormControlInput1" placeholder="Website URL"/>

  </div>
  <div className="container">
  <div class="mb-3 form-check  mt-3">
    <input type="checkbox" class="form-check-input" id="exampleCheck1"/>
    <label class="form-check-label" for="exampleCheck1"><b>Save my name, email, and website in this browser for the next time I comment.</b> </label>
    </div>
  </div>
